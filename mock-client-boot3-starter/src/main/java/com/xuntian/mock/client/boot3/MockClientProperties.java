...
public class MockClientProperties {
    ...
    private List<String> allowedBusinessHeaders = new ArrayList<>();
    private List<String> additionalSensitiveHeaders = new ArrayList<>();
    private List<String> allowedRealHosts = new ArrayList<>();
    ...
    RoutingSnapshot toSnapshot() {
        ...
        allowedBusinessHeaders.forEach(route::allowBusinessHeader);
        additionalSensitiveHeaders.forEach(route::denyHeader);
        allowedRealHosts.forEach(route::allowRealHost);
